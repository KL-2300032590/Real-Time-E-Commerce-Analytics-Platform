...
public class MetricsController {
    ...
    @GetMapping("/revenue/last-hour")
    public Map<String, Object> revenueLastHour() {
        double value = analyticsService.getRevenueLastHour();
        return Map.of("revenueLastHour", value);
    }
    
    @GetMapping("/events-by-type")
    public Map<String, Long> getEventsByType() {
        return analyticsService.getEventTypeBreakdown();
    }

    @GetMapping("/revenue/timeline")
public List<Map<String, Object>> revenueTimeline() {
    return analyticsService.getRevenueTimeline();
}
